...
int Climb_Inhibit;
  ...
  klee_make_symbolic(&Two_of_Three_Reports_Valid, sizeof(int), "Two_of_Three_Reports_Valid");
  klee_make_symbolic(&Own_Tracked_Alt, sizeof(int), "Own_Tracked_Alt");
  klee_make_symbolic(&Own_Tracked_Alt_Rate, sizeof(int), "Own_Tracked_Alt_Rate");
  ...
  klee_make_symbolic(&result_Non_Crossing_Biased_Climb, sizeof(int), "result_Non_Crossing_Biased_Climb");
  klee_make_symbolic(&result_Non_Crossing_Biased_Descend, sizeof(int), "result_Non_Crossing_Biased_Descend");
...
int upward_preferred_1;
	...
	klee_make_symbolic(&alim_Non_Crossing_Biased_Climb, sizeof(int), "alim_Non_Crossing_Biased_Climb");
...
int upward_preferred_2;
	...
	klee_make_symbolic(&alim_Non_Crossing_Biased_Descend, sizeof(int), "alim_Non_Crossing_Biased_Descend");
